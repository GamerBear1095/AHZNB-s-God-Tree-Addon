...
package net.mcreator.ahznbsworldtreeaddon.world.structure;
...
import net.mcreator.ahznbsworldtreeaddon.procedure.ProcedureGodTreeOnStructureInstanceGenerated;
...
public class StructureGodTree extends ElementsAhznbsworldtreeaddonMod.ModElement {
	public StructureGodTree(ElementsAhznbsworldtreeaddonMod instance) {
		super(instance, 5);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("ahznbsworldtreeaddon", "test_struct"));
				if (template == null)
					return;
				...
				int z = spawnTo.getZ();
				{
					...
					ProcedureGodTreeOnStructureInstanceGenerated.executeProcedure($_dependencies);
				}
			}
		}
	}
